...
define('DB_NAME',    $_ENV['DB_NAME']    ?? getenv('DB_NAME')    ?: 'u572945141_Classifieds_db');
define('DB_USER',    $_ENV['DB_USER']    ?? getenv('DB_USER')    ?: 'u572945141_Classifieds_db');
define('DB_PASS',    $_ENV['DB_PASS']    ?? getenv('DB_PASS')    ?: 'Dhiyanshi#28');
